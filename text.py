...
no_canges = 'Или ENTER, чтобы оставить без изменений'

edit_contact = [f'Введите новое имя ({no_canges}): ',
                f'Введите новый телефон ({no_canges}): ',
                f'Введите новый комментарий ({no_canges}): ']
...
exit_no_changes = 'Спасибп. до свидания!'
exit_no_changes_no_confirm = 'Спасибо! До свидания! Изменения не сохранены.'
exit_no_changes_confirm = 'Изменения успешно сохранены.'
exit_changes = 'Были внесены изменения.'
exit_confirm = 'Сохранить?'
